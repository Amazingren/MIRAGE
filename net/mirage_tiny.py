...
class GatedCNNBlock(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        if dynamic_conv:
            # Dynamic convolution kernel generator
...
class MIRAGE(nn.Module):
    ...
    def __init__(
        ...
        self.reduce_shallow = nn.Conv2d(24, 12, 1)
        self.reduce_latent = nn.Conv2d(96, 24, 1)
    ...
    def compute_spd_feature(self, x):
        """
        Extract SPD faetures from x and flatten to a vector (without projection).
        Args:
            x: Tensor [B, C, H, W]
        Returns:
            Tensor [B, C*C]
