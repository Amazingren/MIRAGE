...
class CDD11(Dataset):
    def __init__(self, args, split: str = "train", subset: str = "all"):
        ...
        if split == "train":
            ...
            self.patch_size = 64
        self.cdd11_dir = args.cdd11_path
    ...
    def _init(self):
        data_dir = os.path.join(self.cdd11_dir)
...
class AnyIRTrainDataset(Dataset):
    def __init__(self, args):
        super(AnyIRTrainDataset, self).__init__()
        self.args = args
        self.rs_ids = []
        self.hazy_ids = []
...
class AnyDnTestDataset(Dataset):
    def __init__(self, args):
        super(AnyDnTestDataset, self).__init__()
        self.args = args
        self.clean_ids = []
        self.sigma = 15
...
class AnyIRTestDataset(Dataset):
    def __init__(self, args, task="derain",addnoise = False,sigma = None):
        super(AnyIRTestDataset, self).__init__()
        self.ids = []
        self.task_idx = 0
        self.args = args
